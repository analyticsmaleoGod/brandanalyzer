...
# ── LANDING PAGE ─────────────────────────────────────────────────
st.markdown("<style>.block-container{max-width:820px;padding-top:3rem;}</style>", unsafe_allow_html=True)
...
st.markdown("<p style='font-size:32px;font-weight:800;color:#3B82F6;margin:0 0 8px;line-height:1.2;'>Marketing Intelligence</p>", unsafe_allow_html=True)
st.markdown("<p style='color:#6b7280;font-size:15px;margin-bottom:24px;'>Two tools, one workflow — from data to pitch deck.</p>", unsafe_allow_html=True)
...
with c2:
    if st.button("Logout", key="logout_home", use_container_width=True):
...
with col1:
    st.markdown("""
    <div style="background:#0E0E1C;border:1px solid #1E1E32;border-radius:16px;padding:28px 28px 20px;margin-bottom:12px;">
      ...
      <div style="font-size:13px;color:#9ca3af;line-height:1.65;margin-bottom:12px;">Pull social media performance data across 6 platforms in one click. Powered by Apify + Claude AI analysis.</div>
      <div style="font-size:12px;color:#6b7280;margin-bottom:4px;">✦ Content Performance (IG, TikTok, X, FB, YouTube, LinkedIn)</div>
      <div style="font-size:12px;color:#6b7280;margin-bottom:4px;">✦ Comment Scraper — multi-URL, auto-detect platform</div>
      <div style="font-size:12px;color:#6b7280;margin-bottom:4px;">✦ Keyword & Hashtag Tracker</div>
      <div style="font-size:12px;color:#6b7280;">✦ AI Analysis + Excel/CSV export</div>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div style="background:#0E0E1C;border:1px solid #1E1E32;border-radius:16px;padding:28px 28px 20px;margin-bottom:12px;">
      ...
      <div style="font-size:13px;color:#9ca3af;line-height:1.65;margin-bottom:12px;">End-to-end AI-powered pitching system. From client brief to full pitch deck in under 2 hours, operated by 2 people.</div>
      <div style="font-size:12px;color:#6b7280;margin-bottom:4px;">✦ 7-Phase pipeline: Brief → Research → Big Idea → KV → KPIs → Deck</div>
      <div style="font-size:12px;color:#6b7280;margin-bottom:4px;">✦ SC Approval checkpoints at each phase</div>
      <div style="font-size:12px;color:#6b7280;margin-bottom:4px;">✦ frndOS AI assistant — live chat per phase</div>
      <div style="font-size:12px;color:#6b7280;">✦ Output to Lark Docs + Canva deck</div>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown("---")
st.markdown("<p style='text-align:center;color:#9ca3af;font-size:12px;'>Maleo FCN · frndOS · Internal use only · Built April 2026</p>", unsafe_allow_html=True)
